package com.speedata.pk30dome.utils;
...
import com.speedata.pk30dome.BuildConfig;
...
public final class Logcat {
    ...
    private static String sGlobalTag = "PK30";
    ...
    private static void printDeviceInfo(final String filePath) {
        ...
        int versionCode = 0;
        try {
            PackageInfo pi = MyApp.getInstance().getPackageManager()
    ...
    public static class Config {
        private Config() {
            ...
            if (Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState())
                    && MyApp.getInstance().getExternalCacheDir() != null) {
                sDefaultDir = MyApp.getInstance().getExternalCacheDir() + FILE_SEP + "log" + FILE_SEP;
            } else {
                sDefaultDir = MyApp.getInstance().getCacheDir() + FILE_SEP + "log" + FILE_SEP;
            }
        }
