package com.spd.pk30dome.heavy.adapter;
...
/**
 * @author xuyan  显示查询的数据(不响应点击事件)
 */
public class HeavyLoadAdapter extends BaseQuickAdapter<QuickBean, BaseViewHolder> {

    public HeavyLoadAdapter(@Nullable List<QuickBean> data) {
